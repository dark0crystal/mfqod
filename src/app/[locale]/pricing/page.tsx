          ...
          {cards.map((card) => (
            ...
            >
              <div className="p-6 md:p-8 flex flex-col flex-1">
                ...
                <p className={`text-sm mb-6 ${card.featured ? "text-blue-100" : "text-gray-600"}`}>
                  {card.description}
                </p>
                ...
                <Link
                  href="/login"
                  className={`mt-auto block w-full py-3 px-4 rounded-lg font-semibold text-center transition-colors ${
                    card.featured
