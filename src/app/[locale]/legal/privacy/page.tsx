    ...
    <div className="container mx-auto pb-36 p-8">
      {locale === 'ar' ? (
        <div className="text-right">
          ...
          <p className="mb-4">
            مرحبًا بكم في مفقود. هذا الموقع مخصص لتوثيق الأماكن المفقودة
            في سلطنة عمان. نحن نقدر خصوصيتك ونلتزم بحماية معلوماتك الشخصية.
            باستخدام هذا الموقع، فإنك توافق على الشروط الموضحة في سياسة الخصوصية هذه.
          </p>

          <h2 className="text-2xl font-bold mb-4">المعلومات التي نجمعها</h2>
          <p className="mb-4">
            1. <strong>المعلومات الشخصية:</strong> عند الإبلاغ عن مكان مفقود
            أو التفاعل مع منصتنا، قد نقوم بجمع معلومات شخصية مثل اسمك وعنوان بريدك الإلكتروني.
          </p>
          <p className="mb-4">
            2. <strong>معلومات الأماكن:</strong> أي مكان مفقود تضيفه، بما في ذلك الصور،
            الوصف، والموقع الجغرافي سيتم تخزينه في قاعدة بياناتنا.
          </p>
          ...
          <p className="mb-4">
            نقوم بتطبيق إجراءات أمنية لضمان حماية معلوماتك الشخصية. ومع ذلك، لا يوجد نظام آمن تمامًا.
          </p>
        ...
        <div>
          ...
          <p className="mb-4">
            Welcome to Mafqood. This website is dedicated to documenting lost places in Oman.
          ...
          <p className="mb-4">
            1. <strong>Personal Information:</strong> When you report a lost place
            or interact with our platform, we may collect personal details such as your
            name and email address.
          </p>
          <p className="mb-4">
            2. <strong>Place Information:</strong> Any lost place you add,
          ...
          <p className="mb-4">
            ...
            is protected. However, no system is fully secure.
          </p>
