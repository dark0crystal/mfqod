...
import CompressorFileInput from '@/app/components/CompressorFileInput';
    ...
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-3xl h-fit md:mt-24">
      ...
      {showForm && (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-6 mt-8">
          <div>
            <label htmlFor="claimTitle" className="form-label">Title</label>
            <input
              id="claimTitle"
              {...register("claimTitle")}
              type="text"
          ...
          <div>
            <label htmlFor="claimContent" className="form-label">Proof of ownership</label>
            <input
              id="claimContent"
          ...
          <div className='flex flex-col justify-center items-center h-52'>
            ...
            <Link href="/login" className='btn-primary mt-10 inline-block'>Log In</Link>
          </div>
        ) }
        </>
      )}
